...
- Recording and transcription belong to one input session. Cancel them when the editor changes or the keyboard closes; never insert a late result into another field.
